/*
  Modified by Ivans Saponenko for optimisation
*/ 
...
public:
   ...
   */
  //inline unsigned int readLightSensor() { return readChannel(CH_LIGHT); } // OPTIMISATION ------

  /*
   * Returns the current ambient temperature, expressed either in Celsius
   * or Fahreneit scale.
   */
  //int readTemperature(const byte scale); // OPTIMISATION ------

  /*
   * Returns a number corresponding to the amount of ambient noise.
   */
  //inline unsigned int readMicrophone() { return readChannel(CH_MIC); } // OPTIMISATION ------
  
  //inline unsigned int readJoystickSwitch() { return readChannel(CH_JOYSTICK_SW); } // OPTIMISATION ------
...
//!!!!!!!!!!!
  //int readAccelerometer(const byte axis); // OPTIMISATION ------
  ...
  //void writeRed(byte red); // OPTIMISATION ------
  //void writeGreen(byte green); // OPTIMISATION ------ 
  //void writeBlue(byte blue); // OPTIMISATION ------

  //byte readRed(); // OPTIMISATION ------
  //byte readGreen(); // OPTIMISATION ------
  //byte readBlue(); // OPTIMISATION ------
  
  //void tone(unsigned int freq); // OPTIMISATION ------
  //void tone(unsigned int freq, unsigned long duration); // OPTIMISATION -----
  //void noTone(); // OPTIMISATION ------
  
  
  /* 
  inline unsigned int readTinkerkitInput(byte whichInput) { // OPTIMISATION ---!!!
  ...
  inline unsigned int readTinkerkitInputB() {
    return readChannel(CH_TINKERKIT_B); // OPTIMISATION ----!!!!
  }
  */
};
